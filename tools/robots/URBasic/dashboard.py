...
class DashBoard(threading.Thread): 
    ...
    Example:
    rob = realTimeClient.RT_CLient('192.168.56.101')
    self.close_rtc()
    ...
    def close(self):
        ...
        Example:
        rob = DashBoard('192.168.56.101', rtde_conf_filename='rtde_configuration.xml', logger=logger)
        rob.close_dbs()
        '''
